...
?>
					...
					<br>
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" formAction='court.php'>
							List of courts
						</button>
					</div>
					<br>
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" formAction='judg.php'>
							List of judges
						</button>
					</div>
					<br>
					<div class="container-login100-form-btn">
						<button class="login100-form-btn" formAction='law.php'>
							List of lawyers
						</button>
					</div>
                    <br>
