...
--
-- Database: `epiz_25069142_PROJECT`
--
...
-- Procedures
--
CREATE DEFINER=`epiz_25069142_PROJECT`@`localhost` PROCEDURE `get_judge` ()  select * from judge$$

CREATE DEFINER=`epiz_25069142_PROJECT`@`localhost` PROCEDURE `get_lawyer` ()  select * from lawyer$$
